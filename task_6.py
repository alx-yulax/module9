...
total_stalls = input('Введите строку из десяти символов a и b: ')
summ_milk = 0
for number, current_stall in enumerate(total_stalls, start=1):
    if current_stall == 'b':
        summ_milk += number * 2
print('Произведено молока за день:', summ_milk)
